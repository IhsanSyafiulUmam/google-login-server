        ...
        _createClass(c, [
          ...
          },
          {
            ...
            value: function() {
              ...
              return (
                (a =
                  'undefined' == typeof this.ctx ? [] : this.ctx instanceof HTMLElement ? [this.ctx] : Array.isArray(this.ctx) ? this.ctx : Array.prototype.slice.call(this.ctx)),
                a.forEach(function(a) {
                  if (-1 === b.indexOf(a)) {
                    b.push(a);
                ...
                if (e(i[h])) {
                  ...
                  if (((a = k.splitText(i[h].length)), null !== k.parentNode)) {
                    ...
                    l.setAttribute('data-markjs', 'true'),
                      this.opt.className && l.setAttribute('class', this.opt.className),
                      (l.textContent = i[h]),
